...
<html lang="ko" style="--vh: 7.86px; --global-header-height: 44px;">
    ...
    <head>
        ...
        <script>
            ...
            const telInput = document.getElementById('userTel');  // 전화번호 입력 필드

            // 이메일, 전화번호 입력 필드에 값이 있을 때 버튼을 활성화하고, 비어있으면 비활성화
            function validateFields() {
                let email = emailInput.value.trim();
                let phone = telInput.value.trim();
                
                // 이메일과 전화번호가 비어 있지 않고 유효한 정보인지 확인
                if (email !== "" && fn_validateEmail(email) && phone !== "" && fn_phoneNumber(phone)) {
                    // 이메일, 전화번호가 모두 유효하면 버튼 활성화
                    ...
                    // 이메일 또는 전화번호가 비어있거나 유효하지 않으면 버튼 비활성화
                    ...
                    $(".help_area").append(`
                        ...
                        <div data-v-090e1cc2="">
                            ...
                            <div data-v-090e1cc2="" class="temporary_notice">
                                <p data-v-090e1cc2="" class="notice_txt"> 임시 비밀번호를 전송하였습니다.<br data-v-090e1cc2="">전송 받은 임시 비밀번호로 로그인해주세요. </p>
                            </div>
                            ...
                            <div data-v-05346783="" class="help_area">
                                <div data-v-05346783="">
                                    ...
                                    <div data-v-05346783="" class="help_notice">
                                        <p data-v-090e1cc2="" class="notice_txt"> 가입 시 등록하신 휴대폰 번호와 이메일을 입력하시면,<br data-v-090e1cc2="">휴대폰으로 임시 비밀번호를 전송해 드립니다. </p>
                                    </div>
                                    ...
                                    <div data-v-5f866f8a="" data-v-090e1cc2="" class="input_box">
                                        ...
                                        <div data-v-5f866f8a="" class="input_item">
                                            <input data-v-5f866f8a="" type="tel" id= "userTel" placeholder="가입하신 휴대폰 번호" autocomplete="off" class="input_txt text_fill">
                                        </div>
                                    </div>
